...
// ");
 ...
 foreach (var newType in types.Where(x => !x.Value.IsBuiltIn)) { 
            ...
            #line default
            #line hidden
            this.Write("namespace winrt::OpenApi\r\n{\r\nstruct ");
 ...
 foreach (var property in newType.Value.Members) { 
            ...
            #line 26 "F:\CppWinRTBuilders\CppWinRT.OpenApi\CppWinRTGenerator.tt"
 ...
 if (path.RequestBody != null) { 
   ...
   foreach (var property in path.RequestBody.Properties) { 
            ...
            #line 60 "F:\CppWinRTBuilders\CppWinRT.OpenApi\CppWinRTGenerator.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(property.Name));
  ...
  // parse the json as ");
            ...
            #line 71 "F:\CppWinRTBuilders\CppWinRT.OpenApi\CppWinRTGenerator.tt"
            ...
            #line 72 "F:\CppWinRTBuilders\CppWinRT.OpenApi\CppWinRTGenerator.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(path.ResponseType.CppWinRTName.ToCamelCase()));
            ...
            #line 79 "F:\CppWinRTBuilders\CppWinRT.OpenApi\CppWinRTGenerator.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(path.GetCppName()));
