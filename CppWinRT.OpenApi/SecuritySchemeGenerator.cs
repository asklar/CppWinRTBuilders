...
#line hidden
 ...
 if (_scheme is ApiKeySecurityScheme apiKeyScheme) { 
    ...
    template<typename THttpClient = winrt::Windows::Web::Http::HttpClient, typename = std::enable_if_t<details::IsHttpClientIsh_v<THttpClient>>>
    void apply(const winrt::Windows::Web::Http::HttpRequestMessage& request, const THttpClient& /*client*/) const
    {
        if (_key.empty())
        {
            return;
 ...
 if (apiKeyScheme.In == "header") { 
    ...
    void apply(const winrt::Windows::Web::Http::HttpRequestMessage& request, const THttpClient& client) const
    {
        auto credentials = winrt::Windows::Security::Credentials::PasswordCredential(L""");
            ...
            #line 45 "D:\source\CppWinRTBuilders\CppWinRT.OpenApi\SecuritySchemeGenerator.tt"
            ...
            #line 49 "D:\source\CppWinRTBuilders\CppWinRT.OpenApi\SecuritySchemeGenerator.tt"
...
");
            ...
            #line 57 "D:\source\CppWinRTBuilders\CppWinRT.OpenApi\SecuritySchemeGenerator.tt"
 } 
